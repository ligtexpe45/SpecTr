...
class EarlyStopping:
    ...
    def __init__(self, patience=7, verbose=False, delta=0, output_path='output', experiment_name='experiment', fold=0):
        """
        Args:
    ...
    def __call__(self, val_loss, model, cm):
        ...
        if self.best_score is None:
            ...
            self.save_checkpoint(val_loss, model, cm)
    ...
    def save_checkpoint(self, val_loss, model, cm):
